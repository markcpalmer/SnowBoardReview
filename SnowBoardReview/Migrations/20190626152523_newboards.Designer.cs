...
namespace SnowBoardReview.Migrations
{
    ...
    [Migration("20190626152523_newboards")]
    partial class newboards
    {
            ...
            modelBuilder.Entity("SnowBoardReview.Models.Snowboard", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = 5, ModelDescription = "The board that put us on the map!! For shredding and back country climbing", ModelName = "K2 Standard", ProductImage = "/images/k2board.jpg", SnowboardBrandID = 1 },
                        new { ID = 6, ModelDescription = "Customized to your liking!! Shred or backcountry...your choose!!", ModelName = "Burton Custom", ProductImage = "/images/BurtonCustom.jpg", SnowboardBrandID = 3 }
                    );
                });
